...
#define  DEVICE_NAME "ebbchar1"    ///< The device will appear at /dev/ebbchar using this value
#define  CLASS_NAME  "ebb1"        ///< The device class -- this is a character device driver
